...
exports.ListarSorteiosAtivosServices = void 0;
...
class ListarSorteiosAtivosServices {
    execute(_a) {
        return __awaiter(this, arguments, void 0, function* ({ id, per_page, page }) {
            ...
            const procurarSorteios = yield sorteioModal.find({ admRef: id, drawn: true }).catch((error) => {
                console.log(error);
...
exports.ListarSorteiosAtivosServices = ListarSorteiosAtivosServices;
