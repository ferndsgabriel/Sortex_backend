...
exports.FinalizarRifasServices = void 0;
const mongoose_1 = __importDefault(require("mongoose"));
const sorteioShema_1 = require("../schemas/sorteioShema");
const axiosVerificarPagameto_1 = __importDefault(require("../mercadopago/axiosVerificarPagameto"));
    ...
    execute(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const analisar = procurarSorteio.rifas.map((item) => __awaiter(this, void 0, void 0, function* () {
                ...
                const response = yield (0, axiosVerificarPagameto_1.default)(id);
...
exports.FinalizarRifasServices = FinalizarRifasServices;
