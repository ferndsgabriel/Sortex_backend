...
exports.RespostasPagamento = void 0;
const axiosVerificarPagameto_1 = __importDefault(require("./axiosVerificarPagameto"));
...
class RespostasPagamento {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield (0, axiosVerificarPagameto_1.default)(id); // executo um endpoint do mp que devolve todas as informações da compra através do id
...
exports.RespostasPagamento = RespostasPagamento;
