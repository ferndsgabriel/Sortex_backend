...
const DeletarProdutoServices_1 = require("../services/DeletarProdutoServices");
class DeletarProdutoController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const deleteProduct = new DeletarProdutoServices_1.DeletarProdutoServices();
            try {
                const response = yield deleteProduct.execute(id);
