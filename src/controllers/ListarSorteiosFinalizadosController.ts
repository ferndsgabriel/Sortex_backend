...
import { ListarSorteiosFinalizadosServices } from "../services/ListarSorteiosFinalizadosServices";
...
class ListarSorteiosFinalizadosController {
    async handle(req: Request, res: Response) {
        ...
        const listarSorteios = new ListarSorteiosFinalizadosServices(); 
...
export { ListarSorteiosFinalizadosController };
